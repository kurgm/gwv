...
## 2024-11-18
- 「命名」の項目において、一部の地域ソースグリフの命名規則変更に伴い、命名規則リストを更新しました。古い命名規則は「廃止予定の命名規則」として検出されるようにしました。

## 2024-09-16
- 「地域字形」などの項目において使用している地域ソースのデータを Unicode 16.0.0 のものに更新しました。
...
## 2024-01-20
- 「MJ文字情報一覧表」の項目において使用しているデータを MJ文字情報一覧表Ver.006.02 に更新しました。
